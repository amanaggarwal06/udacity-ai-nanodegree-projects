...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # printing the number of not dog images int the results stats dictionary.
    ...
    # taking out the key from the stats results dictionary
    for key in results_stats_dic:
        ...
        # if the key starts with p then (using the inbuilt function of strings)
